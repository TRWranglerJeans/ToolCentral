...
public class Shop {
	 ...
	 * @param theOrder the order in case the quantity of items drop below 40
	 */
    ...
    /**
    * checks the quantity for all items if they are below 40	
    */
    ...
    /** 
    * creates an order for the items which have a quantity lower than 40	
